...
from src.models.api_models import ResearchResponse, SourceDocument, LandmarkImage
from src.models.research_models import ResearchContext, SourcePassage, RESEARCH_PROMPT_TEMPLATE, CONVERSATION_PROMPT_TEMPLATE
...
class ResearchService:
    ...
    async def generate_report(
        ...
        try:
            ...
            # If we have a specific landmark and didn't find any, add it
            ...
            # Prepare related landmarks
            related_landmarks = []
            for lid in landmark_ids[:5]:  # Limit to 5 related landmarks
                if lid != landmark_id:  # Don't include the primary landmark
    ...
    def _prepare_sources(self, passages: List[SourcePassage], max_sources: int) -> List[SourceDocument]:
        ...
        for passage in sorted_passages:
            ...
            source = SourceDocument(
                ...
                metadata={
                    "landmark_id": passage.landmark_id,
                    **({} if not passage.metadata else passage.metadata)
                }
            )
