...
class AzureOpenAIClient:
    ...
    def __init__(
        ...
        Args:
            ...
            endpoint: Azure OpenAI endpoint URL. If not provided, uses the URL from settings.
            deployment: Deployment name/model to use. If not provided, uses the deployment from settings.
            use_azure_identity: Whether to use Azure Identity for authentication instead of API key.
        """
