...
async def test_query_exception_handling():
    ...
    with mock.patch("requests.post") as mock_post:
        ...
        with pytest.raises(requests.RequestException):
            await asyncio.to_thread(client.query, query_text="Flatiron Building history")
...
async def test_get_landmark_chunks_with_mock():
        ...
        "results": [
            {
                ...
                "metadata": {"landmark_id": "LP-00004", "page": 1},
                "score": 1.0,
            },
            {
                "id": "chunk-2",
                "text": "The Flatiron Building was designed by Daniel Burnham.",
                "metadata": {"landmark_id": "LP-00004", "page": 2},
                "score": 1.0,
            },
        ]
    }
    ...
    with mock.patch("requests.post") as mock_post:
        ...
        # Act
        result = await asyncio.to_thread(client.get_landmark_chunks, landmark_id="LP-00004", top_k=5)
...
async def test_get_document_with_mock():
    ...
    with mock.patch("requests.get") as mock_get:
        ...
        # Act
        result = await asyncio.to_thread(client.get_document, document_id=document_id)
