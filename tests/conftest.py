...
# Import modules after modifying the Python path
# flake8: noqa: E402
...
def mock_memory_service():
    ...
    service.get_conversation_history.return_value = [
        {
            "query": "Tell me about Test Landmark",
            "response": "Test Landmark is a historic building...",
        }
    ]
...
@pytest.fixture
def mock_research_service(mock_vector_client, mock_landmark_client, mock_memory_service, mock_openai_client):
